    ...
    <br/>
      <div class="row">
        <div class="col s12 m8">
            <div class="card">
                <br/>
                <span class="card-title"><h3><center>Valores Discretos</center></h3></span>
                ...
                <br />
                <span class="card-title"><h3><center>Manual de usuario</center></h3></span>
                <hr style={{width: '500px'}}/>
                <span class="card-title"><p><center>Nuevo grupo de Valores Discretos</center></p></span>
                <div class="card-content">
                    <p style={{fontSize: '17px'}} className='text-center'> <em><center>Entiende, ejecuta y configura !!!</center></em></p>
                </div>
        ...
        <div class="col s12 m4">
            <div class="card">
                <br/>
                <span class="card-title"><h3 style={{marginTop:'5px'}}><center>Glosario</center></h3></span>
                <br/>
                <div class="card-image">
