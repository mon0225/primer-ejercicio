    ...
    case 1:
      ...
      <div className="col s12 m10 push-m1">
        <div className="card">
          ...
          <div className="card-action">
            <p ALIGN='justify'><i class="far fa-square" style={{backgroundColor: 'blue'}}></i> Etiqueta azul= <em><b>Nueva Colección</b></em>,</p>
            <p ALIGN='justify'><i class="far fa-square" style={{backgroundColor: 'green'}}></i> Etiqueta verde=<em><b>Nuevo Grupo</b></em>,</p>
            <p ALIGN='justify'><i class="far fa-square" style={{backgroundColor: 'yellow'}}></i> Etiqueta amarilla=<em><b>Nuevos Valores</b></em> y</p>
            <p ALIGN='justify'><i class="far fa-square" style={{backgroundColor: 'red'}}></i> Etiqueta roja=<em><b>Eliminar Datos</b>.</em></p>
          </div>
        </div>
      </div>
    </div>;
